...
public class ChatAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        if(viewType == VIEW_TYPE_SENT){
            ...
            return new ReceivedMessageViewHolder(
                    ItemContainerRecivedMessagesBinding.inflate(LayoutInflater.from(parent.getContext()), parent, false));
        }
    }
    ...
    static class ReceivedMessageViewHolder extends RecyclerView.ViewHolder {
        ...
        private final ItemContainerRecivedMessagesBinding binding;

        public  ReceivedMessageViewHolder(ItemContainerRecivedMessagesBinding itemContainerRecivedMessagesBinding){
            super(itemContainerRecivedMessagesBinding.getRoot());
            binding = itemContainerRecivedMessagesBinding;
        }
