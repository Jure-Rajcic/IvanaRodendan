...
public class ChatActivity extends BaseActivity {
    ...
    private void init() {
        ...
        binding.chatRecycleViewer.setAdapter(chatAdapter);
    ...
    private final EventListener<QuerySnapshot> eventListener = ((value, error) -> {
        ...
        if (value != null) {
            ...
            if (count == 0) {
                ...
                binding.chatRecycleViewer.smoothScrollToPosition(chatMessages.size() - 1);
            }
            binding.chatRecycleViewer.setVisibility(View.VISIBLE);
        }
